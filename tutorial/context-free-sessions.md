...
The bookkeeping and error-handling is exactly what a dedicated, structured channel type for trees lets us avoid, by baking the tree's shape into the protocol itself:
```freest
