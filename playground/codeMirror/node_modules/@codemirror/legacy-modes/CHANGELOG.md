...
Align NSIS mode keywords to language changes.

Fix tokenizing of numbers starting with `0.`.

## 6.5.3 (2026-05-14)

### Bug fixes

Declare type declaration files in package.json exports, to help TS 7 with resolution.
