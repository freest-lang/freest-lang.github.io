...
<br/>
[Install]({{ site.url }}{{ site.baseurl }}\install){: .btn .mr-0 } [Tutorial]({{ site.url }}{{ site.baseurl }}\tutorial){: .btn .mr-0 } [Libraries]({{ site.url }}{{ site.baseurl }}\libraries\Prelude){: .btn .mr-0 } [Publications]({{ site.url }}{{ site.baseurl }}\publications){: .btn .mr-0 } [Team]({{ site.url }}{{ site.baseurl }}\team){: .btn .mr-0 } [Try it online!]({{ site.url }}{{ site.baseurl }}\playground\){: .btn .mr-0 }
{: .text-center }
